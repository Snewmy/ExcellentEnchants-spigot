...
public class JingleEnchant extends AbstractEnchantmentData implements BlockBreakEnchant, CombatEnchant {

    public static final String ID = "jingle";

    public JingleEnchant(@NotNull EnchantsPlugin plugin, @NotNull File file) {
        super(plugin, file);
    ...
    public boolean onBreak(@NotNull BlockBreakEvent event, @NotNull LivingEntity player, @NotNull ItemStack item, int level) {
        UniSound.of(Sound.BLOCK_NOTE_BLOCK_CHIME).play(event.getBlock().getLocation());
        return true;
    }
    ...
    public boolean onAttack(@NotNull EntityDamageByEntityEvent event, @NotNull LivingEntity damager, @NotNull LivingEntity victim, @NotNull ItemStack weapon, int level) {
        ...
        UniSound.of(Sound.BLOCK_NOTE_BLOCK_CHIME).play(event.getEntity().getLocation());
        return true;
    }
