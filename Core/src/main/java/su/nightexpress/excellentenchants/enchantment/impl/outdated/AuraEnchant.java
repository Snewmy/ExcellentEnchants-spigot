...
public class AuraEnchant extends AbstractEnchantmentData implements CombatEnchant {

    public static final String ID = "aura";

    public AuraEnchant(@NotNull EnchantsPlugin plugin, @NotNull File file) {
        super(plugin, file);
